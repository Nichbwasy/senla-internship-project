...
public class RequestRepositoryTests {
    ...
    public void findAllByCarIdTestWithEntityGraph() {
        ...
        requestRepository.save(new Request(null, "NUM1", null, 1L, 1L, new Timestamp(1), new Timestamp(2), new BigDecimal(0), rejection1, status));
        requestRepository.save(new Request(null, "NUM2", null, 1L, 1L, new Timestamp(4), new Timestamp(5), new BigDecimal(0), rejection2, status));
    ...
    public void findAllByUserIdTestWithEntityGraph() {
        ...
        requestRepository.save(new Request(null, "NUM3", null, 2L, 2L, new Timestamp(1), new Timestamp(2), new BigDecimal(0), rejection1, status));
        requestRepository.save(new Request(null, "NUM4", null, 2L, 2L, new Timestamp(4), new Timestamp(5), new BigDecimal(0), rejection2, status));
    ...
    public void findAllByStartTimeBetweenProjectionTest() {
        requestRepository.save(new Request(null, "NUM5", null, 3L, 3L, new Timestamp(10), new Timestamp(11), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM6", null, 3L, 3L, new Timestamp(14), new Timestamp(15), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM7", null, 3L, 3L, new Timestamp(15), new Timestamp(16), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM8", null, 3L, 3L, new Timestamp(18), new Timestamp(19), new BigDecimal(0), null, null));
    ...
    public void findAllByStartTimeBetweenProjectionWithNativeQueryTest() {
        requestRepository.save(new Request(null, "NUM8", null, 4L, 4L, new Timestamp(20), new Timestamp(21), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM9", null, 4L, 4L, new Timestamp(24), new Timestamp(25), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM10", null, 4L, 4L, new Timestamp(25), new Timestamp(26), new BigDecimal(0), null, null));
        requestRepository.save(new Request(null, "NUM11", null, 4L, 4L, new Timestamp(28), new Timestamp(29), new BigDecimal(0), null, null));
